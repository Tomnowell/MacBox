...
final class VMRuntimeManager: ObservableObject {
    ...
    // Always use fresh identifiers for new VM launches to avoid DFU mode
    let reuseEnv = false  // Force fresh install to resolve DFU issues
    let builderFresh = !reuseEnv
